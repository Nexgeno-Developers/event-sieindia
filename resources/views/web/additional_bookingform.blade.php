...
$first_name = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->first_name : null;
$last_name = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->last_name : null;
$email = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->email : null;
$phone = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->phone : null;
$dci_no = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->dci_no : null;
$city = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->city : null;
$zipcode = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->zipcode : null;
$state = isset(auth()->guard('web')->user()->id) ? auth()->guard('web')->user()->state : null;
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="registraiotn_form_box">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="heading_cls">Additional Slots Registration Form</h4>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <form action="{{url('additional_create_booking')}}" method="post" role="form" id="booking_f">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-6 paddright6">
                                        <div class="form-group">
                                            <select class="form-select select2" name="city" id="city" required>
                                                ...
                                                <option value="{{$row->name}}" @if($city == $row->name) selected @endif>
                                                    {{ucfirst($row->name)}}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div id="coupon-block" class="d-none">
                                               <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2 col-1">
                                                                <input onchange="validate_slot_addition(this)"
                                                                    ...
                                                                    @if($total_order >= $business_settings->number_of_order) disabled @endif>
                                                            </div>
...
function finalCart() {
   ...
   /* var addt = $('.slot_addition_main label[for="' + addtt + '"]').find('.topic_desc');
    ...
    $('.finalCart').html(
        '<div class="table-responsive"><table><tbody><tr><th width="10%"><b>Sr. No.</b></th><th width="10%"><b>Slot Name</b></th><th width="15%"><b>Speaker</b></th><th width="30%"><b>Topics</b></th><th width="20%"><b>Date</b></th><th width="15%"><b>Timing</b></th><th width="20%"><b>Amount</b></th></tr><tr class="d-none"><td>1.</td><td>' +
        '</td></tr> '+html2+' </tbody></table></div><div class="text-right"><b>Total: ₹' + pr + '</b></div>');
}
</script>
...
var maxAllowedSelections = {{ $business_set }};
...
$(document).ready(function() {
  ...
  // Reset the selected option for state and city
