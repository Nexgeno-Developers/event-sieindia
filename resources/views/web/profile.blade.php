...
<div class="table-responsive">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <h3 class="mb-3 text-left fs-20"><strong> Registration No</strong> : <span class="text-danger">SIEINDIA{{$user}}</span></h3>     
                        </div>
            ...
            <h3 class="mb-0 text-left fs-20 pt-4 padding_left40 pb-3"><strong class="text-danger"> Order History</h3>
